...
(
    ...
    discount_amount     mediumint unsigned                  NULL comment '値引額',
    discount_rate       mediumint unsigned                  NULL comment '割引率',
    max_discount_amount mediumint unsigned                  NULL comment '最大値引額',
    use_start_at        timestamp default current_timestamp NOT NULL comment '利用開始日',
    use_end_at          timestamp default current_timestamp NOT NULL comment '利用終了日',
    public_start_at     timestamp default current_timestamp NOT NULL comment '公開開始日',
    public_end_at       timestamp default current_timestamp NOT NULL comment '公開終了日',
